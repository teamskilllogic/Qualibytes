            ...
            {[
              ...
              },
              {
                ...
                points: [
                  ...
                  "Advanced Git: stash, rebase, cherry-pick",
                ],
              },
              {
              ...
              {
                title: "Week 7: Terraform & Infrastructure as Code",
                points: [
              ...
              {
                title: "Week 8: Ansible for Configuration Management",
                points: [
                  "Ansible basics: playbooks, inventory",
                  "Roles, variables, and Jinja2",
              ...
              },
              {
                ...
                points: [
                  "K8s core concepts: pods, deployments",
                  "YAML and declarative management",
                  "Namespaces, Secrets, ConfigMaps",
                ],
              },
              {
                title: "Week 10: Advanced Kubernetes & Project Deployment",
                points: [
                  "Ingress, TLS, DNS",
                  "StatefulSets, PVCs",
                  "RBAC, real-world deployment on EKS",
                ],
              },
              {
                title: "Week 11: Monitoring & Observability",
                points: [
                  "Prometheus setup and exporters",
                  "Grafana dashboards",
                  "Monitoring Kubernetes, scaling, logging",
                ],
              },
              {
                title: "Week 12: Final Projects & Job Preparation",
                points: [
                  "CI/CD with Jenkins, Docker, K8s",
                  "Terraform + Ansible deployment",
                  "Monitoring stack + Resume + Mock Interviews",
                ],
              },
            ].map((week, index) => (
              <div
