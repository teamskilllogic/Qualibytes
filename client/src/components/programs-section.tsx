      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedPrograms.map((program) => (
            <Card
              key={program.id}
              className="bg-black dark:bg-black light:bg-white overflow-hidden hover:shadow-xl transition-shadow"
            >
              <img
                src={
                  program.imageUrl ||
                  "https://images.unsplash.com/photo-1531297484001-80022131f5a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200"
                }
              ...
              <CardContent className="p-6">
                <div className="mb-3">
                  ...
                  {program.isNew && (
                    <Badge
                      variant="secondary"
                      className="bg-accent text-black ml-2"
                    >
                      NEW
                    </Badge>
                  )}
                ...
                <h4 className="text-xl font-semibold mb-2 text-white dark:text-white light:text-gray-900">
                  {program.title}
                </h4>
