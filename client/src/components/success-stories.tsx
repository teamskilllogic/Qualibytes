      ...
      <section className="py-16 bg-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">SHAPING SUCCESS STORIES SINCE 2019</h2>
            <h3 className="text-xl text-gray-600">Your Journey, Our Mission</h3>
          </div>
